...
/**
 * check_elf -Checks if  file is a ELF file.
 * @e_ident: The pointer to array containing a ELF magic numbers.
 ...
 * @e_ident: The pointer to array containing  ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	t = read(v, header, sizeof(Elf64_Ehdr));
	if (t == -1)
	{
		free(header);
		close_elf(v);
